...
def app():
    ...
    gre_score = form.number_input('GRE Score', min_value=270, max_value=340, step=1, value=300)
    toefl_score = form.number_input('TOEFL Score', min_value=80, max_value=120, step=1, value=100)
